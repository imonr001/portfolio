...
function Projects() {
  return (
    <div name="projects" className="w-full h-full text-gray-300 bg-[#0a192f] p-28 ">
      <div className="max-w-[1000px] mx-auto p-4 flex  justify-center w-full h-full ">
        <div className=" p-8 mr-72 md:mr-auto  pb-8 md:text-center sm:text-left">
          <p className="text-4xl font-bold inline border-b-4 text-gray-300 border-yellow-300">
            Projects
          </p>
          <div className=" justify-items-start w-full   grid grid-cols-1 sm:grid-cols-3 sm:gap-96   ">
            <Card
